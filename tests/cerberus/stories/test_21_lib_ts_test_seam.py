...
def test_21_1_1_skips_repos_with_no_typescript_packages(run_lib_ts_tests: RunLibTsTests, skip: MakeFinding) -> None:
...
def test_21_2_4_fails_a_library_whose_exports_omit_the_root_entry(
    ...
    assert result.findings == [fail("packages/lib/package.json: library exports must include the '.' root seam")]
